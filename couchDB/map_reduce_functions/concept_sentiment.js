function(doc) {
                    topic_list = ["rt", "hypertexttransferprotocol", "day", "match", "people", "voting", "candidate", "campaign", "man", "station", "page", "final", "fight", "host", "left", "home", "report", "tomorrow", "work", "woman", "elector", "block", "coalition", "job", "today", "government", "support", "country", "future", "card", "friend", "celebrate", "photograph", "political", "selfie", "idiot", "guy", "change", "event", "family", "hope", "result", "video", "arrogant", "call", "city", "mother", "service", "business", "chance", "district", "front", "coach", "rally", "child", "dream", "manager", "sunday", "policy", "love", "place", "position", "world", "school", "fan", "politician", "telephone", "economy", "opening", "ballot", "fair", "car", "money", "council", "sex", "student", "media", "democracy", "team", "open", "society", "tax", "food", "decision", "teacher", "member", "specialist", "jew", "exam", "start", "supporter", "cast", "blog", "boy", "green", "club", "poster", "bank", "blue", "person"]
