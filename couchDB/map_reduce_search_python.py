...
ret10 = create_view('http://localhost:5984/', 'twit3', 'most_favourited_tweet.js', '', 'most_favourited_tweet', 'most_favourited_tweet')
# ret11 = create_view('http://115.146.93.167:5984/', 'twit', 'most_favourited_tweet.js', '', 'most_favourited_tweet', 'most_favourited_tweet')
